...
export type Project = {
  ...
  export const PROJECTS: Project[] = [
    ...
    description:
      ...
      categories: "DISEÑO ARQUITECTÓNICO / DISEÑO DE INTERIOR",
      description:
      "Diseñada para una familia en el corazón del Caribe mexicano, Casa Cascada nace como una interpretación contemporánea del trópico: cálida, ventilada y abierta, pero también introspectiva, sobria y bien contenida. Desde su fachada, la casa plantea un lenguaje de planos verticales en secuencia, como si el volumen se tejiera a partir de líneas que se desplazan y dan ritmo a la composición. Esta estrategia no solo organiza la arquitectura, sino que crea profundidad visual y otorga carácter desde el primer contacto. El gesto que da nombre a la casa surge en el acceso vehicular, donde se abre una fisura en la losa tapa, permitiendo que la luz del sol se cuele y caiga como una cascada vertical. No es agua, sino luz lo que fluye hacia abajo, bañando el concreto y proyectando sombras móviles que cambian con el día. Este momento transforma lo cotidiano - entrar a casa - en una experiencia arquitectónica sensible. Al interior, los espacios se articulan de manera fluida pero estratégica, integrando vegetación, ventilación cruzada y un equilibrio entre sombra y apertura. La materialidad se basa en texturas tropicales, maderas cálidas, muros neutros y superficies que dialogan con el entorno sin competir con él. Casa Cascada es una vivienda hecha de luz, ritmo y pausa. Una pieza que se funde con su clima, que se refresca desde dentro, y que convierte los elementos del trópico en lenguaje arquitectónico"
    },
